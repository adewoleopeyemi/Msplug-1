...
public class requestlistresponse {
    ...
    private boolean is_multi_step;

    public boolean isIs_multi_step() {
        return is_multi_step;
    }

    @SerializedName("multi_step")
    private String multi_step;

    public void setIs_multi_step(boolean is_multi_step) {
        this.is_multi_step = is_multi_step;
    }

    public String getMulti_step() {
        return multi_step;
    }

    public void setMulti_step(String multi_step) {
